...
def generate_data(dataset, label):
    ...
    target_filename = 'OPPORTUNITYDATASET.txt'
    data_dir ='/LSTM_Security/'
    
    #if os.path.exists(os.path.join(data_dir, target_filename)):
...
if __name__ == '__main__':
    ...
    generate_data(OpportunityUCIDataset_zip,label)
